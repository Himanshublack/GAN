...
# Loading the dataset
dataset = dset.CIFAR10(root='D:/gan/data', download=True,
...
if __name__ == '__main__':
    for epoch in range(25):
        ...
        for i, data in enumerate(dataloader, 0):
            ...
            if i % 100 == 0:
                vutils.save_image(real, '%s/real_samples.png' % "D:/gan/results", normalize=True)
                fake = netG(noise)
                vutils.save_image(fake.data, '%s/fake_samples_epoch_%03d.png' % ("D:/gan/results", epoch), normalize=True)